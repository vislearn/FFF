...
def compute_jacobian(
    ...
    **func_kwargs: Any,
    ...
    :param fn: The function to compute the jacobian of.
    ...
    :return: The jacobian of the function with respect to the input tensor."""
...
def compute_volume_change(jac: torch.Tensor) -> torch.Tensor:
    ...
    :param jac: The jacobian of the function.
    :return: The volume change of the function."""
